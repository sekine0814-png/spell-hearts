...
function openSummonConfirm(){
  ...
  if(yes)yes.onclick=()=>{
    ...
    dialog.innerHTML='<div class="summon-animation-box" aria-label="召喚中"><img class="summon-animation-gate" src="assets/spell-hearts-summon-gate.png" alt=""><div class="summon-particles"><i></i><i></i><i></i><i></i><i></i><i></i><i></i><i></i><i></i></div><div class="summon-falling-shard">✦</div></div>';
    setTimeout(()=>{
