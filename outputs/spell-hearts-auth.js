...
function openSummonConfirm(){
  ...
  if(yes)yes.onclick=()=>{
    ...
    dialog.innerHTML='<div class="summon-animation-box" aria-label="召喚中"><img class="summon-vortex" src="assets/spell-hearts-star-vortex.png" alt=""><img class="summon-animation-gate" src="assets/spell-hearts-summon-gate.png" alt=""><div class="summon-particles"><i></i><i></i><i></i><i></i><i></i><i></i><i></i><i></i><i></i></div><div class="summon-falling-shard">✦</div></div>';
    setTimeout(()=>{
      ...
      dialog.innerHTML='<div class="summon-confirm-box summon-result-box"><div class="summon-result-shard">✦</div><p>星のカケラがひとつ落ちてきました</p><button type="button" class="summon-confirm-no">受け取る</button>';
      dialog.querySelector('.summon-confirm-no').onclick=()=>dialog.hidden=true;
    },2600);
  };
}
