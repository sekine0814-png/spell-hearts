...
function makeTokenBalance(){
  ...
  balance.innerHTML='<span class="token-coin" aria-hidden="true">✦</span><span class="token-count">0</span>';
...
tokenStyle.textContent='.token-balance{position:absolute;z-index:3;right:34px;bottom:5vh;display:inline-flex;align-items:center;gap:10px;min-width:78px;padding:9px 13px;border:1px solid #d8ae4e;border-radius:5px;background:rgba(3,5,8,.76);box-shadow:inset 0 0 13px rgba(255,225,135,.12),0 2px 12px #0009;color:#fff0ad;font:bold 22px Georgia,"Yu Mincho",serif;text-shadow:0 1px 3px #000}.token-coin{display:grid;place-items:center;width:27px;height:27px;border:1px solid #ffe18a;border-radius:50%;background:radial-gradient(circle at 33% 28%,#fffbd0 0 8%,#f4ca4e 26%,#b46b13 64%,#62340a 100%);box-shadow:inset 0 0 5px #fff5af,0 0 8px #d89920;color:#fff7c0;font:15px Georgia,serif;text-shadow:0 1px 2px #704000}.token-count{min-width:2ch;text-align:right}.result-token-reward{display:inline-flex;align-items:center;gap:10px;margin-top:20px;padding:8px 15px;border:1px solid rgba(225,184,77,.8);border-radius:5px;background:rgba(3,5,8,.74);box-shadow:inset 0 0 13px rgba(255,225,135,.12),0 2px 12px #0009;color:#fff0ad;font:bold clamp(20px,2.7vw,32px) Georgia,"Yu Mincho",serif;text-shadow:0 1px 3px #000}.result-token-reward .token-coin{width:30px;height:30px;font-size:17px}@media(max-width:600px){.token-balance{right:16px;bottom:4vh;padding:7px 10px;font-size:18px}.token-coin{width:23px;height:23px;font-size:13px}.result-token-reward{margin-top:14px;padding:7px 12px}}';
